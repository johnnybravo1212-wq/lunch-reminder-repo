...
def build_reminder_message_blocks(menu_items, user_id=None):
    ...
    blocks.extend([
        ...
        {"type": "actions", "elements": [
            {"type": "button", "text": {"type": "plain_text", "text": "🍽️ Objednat v LunchDrive"}, "style": "primary", "url": "lunchdrive://open", "action_id": "open_lunchdrive_app"},
